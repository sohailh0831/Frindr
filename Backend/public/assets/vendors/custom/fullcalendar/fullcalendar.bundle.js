    ...
    return function(t) {
        ...
        e.isPrimaryMouseButton = function(t) {
            ...
            var e,
                ...
                r = [],
                o = [];
            for ("string" == typeof t ? o = t.split(/\s*,\s*/) : "function" == typeof t ? o = [t] : i.isArray(t) && (o = t), e = 0; e < o.length; e++)
                "string" == typeof (n = o[e]) ? r.push("-" === n.charAt(0) ? {
                    field: n.substring(1),
                    order: -1
                } : {
                    field: n,
            ...
            o = function() {
                ...
                return t.invertRanges = function(e, n) {
                    var r,
                        ...
                        o = [],
                        a = n.startMs;
                    for (e.sort(s), r = 0; r < e.length; r++)
                        (i = e[r]).startMs > a && o.push(new t(a, i.startMs)), i.endMs > a && (a = i.endMs);
        ...
        e.default = c, c.utc = function() {
            ...
            if (!this._fullCalendar)
                return u.time.apply(this, arguments);
            if (null == t)
                return r.duration({
                    hours: this.hours(),
            ...
            s = function() {
                ...
                return t.prototype.getAllEventRanges = function(t) {
                    ...
                    for (e = 0; e < i.length; e++)
                        (r = (n = i[e]).dateProfile.unzonedRange.intersect(t)) && s.push(new o.default(r, n.def, n));
                    return s
            ...
            i = function() {
                ...
                return t.prototype.processIconOverride = function() {
                    ...
                    if (r.isPlainObject(t)) {
                        for (n in e = r.extend({}, this.iconClasses), t)
            ...
            o = function() {
                ...
                return t.prototype.opt = function(t) {
                    ...
                    var e,
                        ...
                        s = [];
                    for (e in t)
                        r = (n = t[e]).sliceRenderRanges(i.activeUnzonedRange), n.getEventDef().hasBgRendering() ? o.push.apply(o, r) : s.push.apply(s, r);
                    ...
                    return {
                        fakeFormatString: function t(e) {
                            ...
                            for (r = 0; r < e.length; r++)
                                "string" == typeof (i = e[r]) ? n.push("[" + i + "]") : i.token ? i.token in u ? n.push(s + "[" + i.token + "]") : n.push(i.token) : i.maybe && n.push(a + t(i.maybe) + a);
                            return n.join(o)
                        }(e),
                        sameUnits: function t(e) {
                            ...
                            var o;
                            for (r = 0; r < e.length; r++)
                                (i = e[r]).token ? (o = d[i.token.charAt(0)], n.push(o ? o.unit : "second")) : i.maybe ? n.push.apply(n, t(i.maybe)) : n.push(null);
                            return n
                        }(e)
                    }
                }(t))
        ...
        function v(t, e) {
            ...
            for (n = 0; n < l.length; n++)
                (i = l[n]).charAt(0) === s ? a.push(u[i.substring(1)](e)) : a.push(i);
            return a
        }
        function y(t) {
        ...
        var r = n(2),
            ...
            a = function(t) {
                ...
                return r.__extends(e, t), e.watch = function(t) {
                    ...
                    if (i) {
                        for (e in this.trigger("before:batchChange", r), r)
                            n = r[e], this.trigger("before:change", e, n), this.trigger("before:change:" + e, n);
                        for (e in r)
                            void 0 === (n = r[e]) ? delete this._props[e] : this._props[e] = n, this.trigger("change:" + e, n), this.trigger("change", e, n);
            ...
            o = function(t) {
                ...
                return r.__extends(e, t), e.prototype.updateDayTable = function() {
                    ...
                    for (e = 0; e < this.rowCnt; e++)
                        r = (n = e * s) + s - 1, i = Math.max(l, n), o = Math.min(u, r), (i = Math.ceil(i)) <= (o = Math.floor(o)) && d.push({
                            row: e,
                    ...
                    var e,
                        ...
                        c = [];
                    for (e = 0; e < this.rowCnt; e++)
                        for (r = (n = e * a) + a - 1, i = n; i <= r; i++)
                            o = Math.max(u, i), s = Math.min(d, i), (o = Math.ceil(o)) <= (s = Math.floor(s)) && c.push({
                                row: e,
            ...
            m = function(t) {
                ...
                return r.__extends(e, t), e.prototype.componentFootprintToSegs = function(t) {
                    ...
                    for (e = 0; e < s.length; e++)
                        if (n = s.eq(e).removeClass("fc-limited"), r = 0, n.find("> td > :first-child").each(a), n.position().top + r > o)
                            return e;
                    return !1
                    ...
                    var n,
                        ...
                        E = function(n) {
                            for (; D < n;)
                                (l = m.getCellSegs(t, D, e)).length && (c = r[e - 1][D], y = m.renderMoreLink(t, D, l), v = i("<div/>").append(y), c.append(v), w.push(v[0])), D++
                        };
                    if (e && e < b.segLevels.length) {
                        for (n = b.segLevels[e - 1], r = b.cellMatrix, o = b.tbodyEl.children().slice(e).addClass("fc-limited").get(), s = 0; s < n.length; s++) {
                            for (E((a = n[s]).leftCol), d = [], u = 0; D <= a.rightCol;)
                                l = this.getCellSegs(t, D, e), d.push(l), u += l.length, D++;
                            if (u) {
                                for (p = (c = r[e - 1][a.leftCol]).attr("rowspan") || 1, h = [], f = 0; f < d.length; f++)
                    ...
                    for (n = this.eventRenderer.renderFgSegEls(n, !0), this.popoverSegs = n, r = 0; r < n.length; r++)
                        this.hitsNeeded(), n[r].hit = this.getCellHit(t, e), this.hitsNotNeeded(), u.append(n[r].el);
                    return l
                    ...
                    var n,
                        ...
                        p = [];
                    for (n = 0; n < t.length; n++)
                        (o = (r = t[n]).footprint.componentFootprint.unzonedRange.intersect(c)) && p.push(i.extend({}, r, {
        ...
        var r = n(5),
            ...
            l = function() {
                ...
                return t.prototype.opt = function(t) {
                    ...
                    for (e = 0; e < r.length; e++)
                        if (!this.isFootprintAllowed(r[e].componentFootprint, o, s, l, r[e].eventInstance))
                            return !1;
                    if (u)
                        for (e = 0; e < r.length; e++)
                            if (!1 === u(r[e].componentFootprint.toLegacy(this._calendar), r[e].getEventLegacy()))
                                return !1;
                    return !0
                    ...
                    var e,
                        n = this.eventManager.getEventInstances().map(a.eventInstanceToEventRange),
                    ...
                    var o,
                        s;
                    if (null != n && (o = this.constraintValToFootprints(n, t.isAllDay), !this.isFootprintWithinConstraints(t, o)))
                        return !1;
            ...
            u = function(t) {
                ...
                return r.__extends(e, t), e.prototype.isAllDay = function() {
                    ...
                    for (var e, n, r, i = this.source.calendar, o = t.getStart(), s = t.getEnd(), u = []; o.isBefore(s);)
                        this.dowHash && !this.dowHash[o.day()] || (n = (e = i.applyTimezone(o)).clone(), r = null, this.startTime ? n.time(this.startTime) : n.stripTime(), this.endTime && (r = e.clone().time(this.endTime)), u.push(new a.default(this, new l.default(n, r, i)))), o.add(1, "days");
                    return u
        ...
        var r = n(3),
            ...
            u = function() {
                ...
                return t.prototype.buildEventInstanceGroup = function(t, e) {
                    ...
                    if (r.length)
                        return (n = new o.default(i.eventDefsToEventInstances(r, e))).explicitEventDef = r[0], n
        ...
        var r = n(2),
            ...
            l = function(t) {
                ...
                return r.__extends(e, t), e.prototype.add = function(t) {
                    var e,
                        n = 0;
                    for (e in this.recordOverrides(t), t)
                        n++;
                    if (1 === n) {
            ...
            h = function() {
                ...
                return t.prototype.requestEvents = function(t, e, n, r) {
                    ...
                    var n,
                        ...
                        o = [];
                    for (n = 0; n < i.length; n++)
                        (r = i[n].clone()) instanceof u.default && (e.mutateSingle(r), o.push.apply(o, r.buildInstances()));
            ...
            o = function(t) {
                ...
                return r.__extends(e, t), e.prototype.renderFgSegs = function(t) {
                    ...
                    if (f.unshift("fc-time-grid-event", "fc-v-event"), s.isMultiDayRange(l.unzonedRange)) {
                        ...
                        n = this.getTimeText(t.footprint), r = this.getTimeText(t.footprint, "LT"), o = this.getTimeText(t.footprint, null, !1);
        ...
        function s(t) {
            ...
            if (void 0 === t.forwardPressure) {
                for (e = 0; e < r.length; e++)
                    s(n = r[e]), i = Math.max(i, 1 + n.forwardPressure);
                t.forwardPressure = i
            }
        }
        function a(t, e, n) {
            ...
            for (var r = 0; r < e.length; r++)
                i = t, o = e[r], i.bottom > o.top && i.top < o.bottom && n.push(e[r]);
            var i,
                o;
            return n
        }
        ...
        var r = n(2),
            ...
            s = function(t) {
                ...
                return r.__extends(e, t), e.prototype.renderBgRanges = function(e) {
                    ...
                    function y(t) {
                        for (; o < t;)
                            (u = (v[n - 1] || [])[o]) ? u.attr("rowspan", parseInt(u.attr("rowspan") || 1, 10) + 1) : (u = i("<td/>"), s.append(u)), g[n][o] = u, v[n][o] = u, o++
                    }
                    for (n = 0; n < p; n++) {
                        if (r = c[n], o = 0, s = i("<tr/>"), f.push([]), g.push([]), v.push([]), r)
                            for (a = 0; a < r.length; a++) {
                                for (y((l = r[a]).leftCol), u = i('<td class="fc-event-container"/>').append(l.el), l.leftCol !== l.rightCol ? u.attr("colspan", l.rightCol - l.leftCol + 1) : v[n][o] = u; o <= l.rightCol;)
                                    g[n][o] = u, f[n][o] = l, o++;
                                s.append(u)
                            }
            ...
            var r = n(2),
                ...
                s = function(t) {
                    ...
                    return r.__extends(e, t), e.parse = function(t, e) {
                        ...
                        var r,
                            o = this.googleCalendarApiKey || this.calendar.opt("googleCalendarApiKey");
