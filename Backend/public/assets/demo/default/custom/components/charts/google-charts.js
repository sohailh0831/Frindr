    ...
    runDemos: function() {
        ...
        ! function() {
            ...
            new google.visualization.ColumnChart(document.getElementById("m_gchart_1")).draw(e, a), new google.visualization.ColumnChart(document.getElementById("m_gchart_2")).draw(e, a)
                ...
                [13, 4.8, 6.3, 3.6],
                [14, 4.2, 6.2, 3.4]
            ]), new google.charts.Line(document.getElementById("m_gchart_5")).draw(e, {
                chart: {
            ...
            function() {
                ...
                new google.visualization.PieChart(document.getElementById("m_gchart_3")).draw(e, a), a = {
                    pieHole: .4
                }, new google.visualization.PieChart(document.getElementById("m_gchart_4")).draw(e, a)
            }()
    }
};
